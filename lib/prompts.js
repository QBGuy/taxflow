...
const prompts = [
  ...
  },
  {
    ...
    extra_rules: "Return 2-3 paragraphs. Use 'New Knowledge Produced' as your header.",
    examples: 
    `
    EXAMPLE_OUTPUT_1 
  ...
  },
  {
    ...
    extra_rules: "Return 2-3 paragraphs. Use 'Sources and Discoveries' as your header.",
    examples: 
    `
    EXAMPLE_OUTPUT_1 
  ...
  },
  {
    ...
    Use 'Experimental Procedure' as your header.
    `,
    examples: 
    `
    EXAMPLE_OUTPUT_1
